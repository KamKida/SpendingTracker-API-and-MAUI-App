	...
	public class FundCategotuService : IFundCategotuService
	{
		...
		public async Task<HttpResponseMessage> Get10(FundCategoryFilterRequest request, bool useDatesFromToo = false)
		{
			...
			try
			{
				...
				_logger.LogInformation(
					"Wynik pobierania 10 kategorii funduszy: StatusCode={StatusCode}",
					response.StatusCode
				);
		...
		public async Task<HttpResponseMessage> AddFundCategory(FundCategoryRequest request)
		{
			...
			try
			{
				...
				_logger.LogInformation(
					"Wynik dodawania kategorii funduszy: Name={Name}, ShouldBe={ShouldBe}, StatusCode={StatusCode}",
					request.Name,
					request.ShouldBe,
					response.StatusCode
				);
		...
		{
			_logger.LogInformation(
				"Rozpoczynam wywołanie API usuwania kategorii funduszu. FundCategoryId={FundCategoryId}",
				id
			);
			...
			try
			{
				...
				_logger.LogInformation(
					"Wynik wywołania API usuwania kategorii funduszu. FundCategoryId={FundCategoryId}, StatusCode={StatusCode}",
					id,
					response.StatusCode
				);
			...
			catch (HttpRequestException httpEx)
			{
				_logger.LogError(
					httpEx,
					"Błąd HTTP podczas wywołania API usuwania kategorii funduszu. FundCategoryId={FundCategoryId}",
					id
				);
				throw;
			}
			catch (Exception ex)
			{
				_logger.LogError(
					ex,
					"Nieoczekiwany błąd podczas wywołania API usuwania kategorii funduszu. FundCategoryId={FundCategoryId}",
					id
				);
				throw;
			}
		...
		{
			_logger.LogInformation(
				"Rozpoczynam wywołanie API edycji kategorii funduszu. FundCategoryId={FundCategoryId}, ShouldBe={ShouldBe}",
				request.Id,
				request.ShouldBe
			);
			...
			try
			{
				...
				_logger.LogInformation(
					"Wynik wywołania API edycji kategorii funduszu. FundCategoryId={FundCategoryId}, StatusCode={StatusCode}",
					request.Id,
					response.StatusCode
				);
			...
			catch (HttpRequestException httpEx)
			{
				_logger.LogError(
					httpEx,
					"Błąd HTTP podczas wywołania API edycji kategorii funduszu. FundCategoryId={FundCategoryId}, ShouldBe={ShouldBe}",
					request.Id,
					request.ShouldBe
				);
				throw;
			...
			catch (Exception ex)
			{
				_logger.LogError(
					ex,
					"Nieoczekiwany błąd podczas wywołania API edycji kategorii funduszu. FundCategoryId={FundCategoryId}, ShouldBe={ShouldBe}",
					request.Id,
					request.ShouldBe
				);
				throw;

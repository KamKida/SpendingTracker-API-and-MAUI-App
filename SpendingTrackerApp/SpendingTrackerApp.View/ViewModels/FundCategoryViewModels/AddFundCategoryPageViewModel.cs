	...
	public class AddFundCategoryPageViewModel : INotifyPropertyChanged
	{
		...
		public async Task Reset()
		{
			...
			try
			{
				...
				Message = "Format: 00.00. Do 15 przed przecinkiem, 2 po przecinku. Jedynie liczby dodatnie. Nazwa jest wymagana";
		...
		public async Task AddFundCategory()
		{
			...
			try
			{
				...
				if (!goodShouldBe)
				{
					...
					Message = "Format: 00.00. Do 15 przed przecinkiem, 2 po przecinku. Jedynie liczby dodatnie.";
